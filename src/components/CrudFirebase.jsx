...
const CrudFirebase = (props) => {
    ...
    const agregarTarea = async (e) => {
        ...
        try{
            ...
            let data = await db.collection('tareas').add(nuevaTarea)
    ...
    const editarTarea = async (e) => {
        ...
        try{
            ...
            await db.collection('tareas').doc(id).update({detalle: tarea, status: status})
    ...
    return (
        ...
        { tareas.map( (item, i) => (
            ...
            export default withRouter(CrudFirebase)
